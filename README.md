...
[![1.21.11](https://img.shields.io/badge/Latest_version-1.21.11-4fa31a?style=for-the-badge)](https://github.com/ModernSpout/Spout-Paper-server/releases/download/1.21.11-R0.9/spout-1.21.11-R0.9.jar)
...
* [Latest version: 1.21.11-R0.9](https://github.com/ModernSpout/Spout-Paper-server/releases/download/1.21.11-R0.9/spout-1.21.11-R0.9.jar)
...
```sh
java -jar spout-1.21.11-R0.9.jar
```
